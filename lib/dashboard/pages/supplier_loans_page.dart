...
class SupplierLoansPage extends StatefulWidget {
  const SupplierLoansPage({super.key});

  @override
  State<SupplierLoansPage> createState() => _SupplierLoansPageState();
}

class _SupplierLoansPageState extends State<SupplierLoansPage> {
  ...
  Future<void> _loadLoans() async {
    ...
    try {
      final loans = await _db.getSupplierLoans();
      if (!mounted) return;
      setState(() {
        _loans = loans;
        _isLoading = false;
            ...
            child: AlertDialog(
              ...
              content: SizedBox(
                ...
                child: Column(
                  ...
                  children: [
                    Text('${l10n.loansSupplierName}: ${loan['supplier_name'] ?? '-'}'),
                    Text('${l10n.loansCompanyName}: ${loan['supplier_company'] ?? '-'}'),
              ...
              actions: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    ...
                    final paymentId = await _db.insertSupplierLoanPayment({
                      'loan_id': loanId,
                      'amount': amount,
                    ...
                    await _db.updateSupplierLoanPaid(loanId, paid, updatedRemaining);
                ...
                pw.Container(
                  ...
                  child: pw.Column(
                    ...
                    children: [
                      ...
                      pw.Text(
                        '${l10n.loansSupplierName}: ${loan['supplier_name'] ?? '-'}',
                        style: pw.TextStyle(font: ttf, fontSize: 10),
                      ),
                      pw.Text(
                        '${l10n.loansCompanyName}: ${loan['supplier_company'] ?? '-'}',
                        style: pw.TextStyle(font: ttf, fontSize: 10),
                      ),
                      pw.Text(
  ...
  Widget build(BuildContext context) {
    ...
    return Directionality(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text(l10n.loansPageTitleSupplier),
          backgroundColor: const Color(0xFFCB001D),
          foregroundColor: Colors.white,
        ),
        body: Padding(
